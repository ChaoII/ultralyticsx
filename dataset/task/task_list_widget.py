...
from models.models import Task, Project, Dataset
...
class TaskWidget(QWidget):
    ...
    def _connect_signals_and_slots(self):
        self.btn_create_dataset.clicked.connect(self._on_create_dataset)
    ...
    def _on_create_dataset(self):
        # 创建任务路径
        with db_session() as session:
            dataset_id = self.get_dataset_id(self.dataset_root_dir)
            os.makedirs(self.dataset_root_dir / dataset_id, exist_ok=True)
            task = Dataset(
